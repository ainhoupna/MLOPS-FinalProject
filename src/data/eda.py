...
def plot_time_amount_distribution(df, save_dir="reports/figures"):
    ...
    sns.histplot(df[df['Class'] == 0]['Time'], bins=50, kde=True, color='blue', label='Normal', alpha=0.3)
...
def plot_feature_distributions(df, save_path="reports/figures/feature_distributions.png"):
    ...
    for i, col in enumerate(v_features):
        plt.subplot(8, 4, i+1)
        sns.kdeplot(df[df['Class'] == 0][col], label="Legitimate", shade=True, color="blue")
